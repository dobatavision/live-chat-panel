...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
        ...
        <!-- Login Modal -->
        <div id="loginModal" class="modal" style="{{ $errors->has('email') ? 'display:flex;' : '' }}">
        ...
        <!-- Register Modal -->
        <div id="registerModal" class="modal" style="{{ $errors->any() && !$errors->has('email') ? 'display:flex;' : '' }}">
            <div class="modal-content">
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="group" id="group" class="mt-1 block w-full" required>
